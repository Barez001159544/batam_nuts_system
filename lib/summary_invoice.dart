import 'package:bn_sl/invoice/invoice.dart';
...
class SummaryInvoice extends StatefulWidget {
  const SummaryInvoice({super.key});

  @override
  State<SummaryInvoice> createState() => _SummaryInvoiceState();
}
List pageController=[
...
ReturnInvoicePagination? orderPagnation;
...
class _SummaryInvoiceState extends State<SummaryInvoice> {
  product() {
    (() async {
      Invoice pagnation = new Invoice();
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Tooltip(
                              message: "Order by Total",
                              child: GestureDetector(
                                onTap:(){
                                  setState(() {
                                    pagnationParameter.sortField="total";
                                    pagnationParameter.sortOrder=pagnationParameter.sortOrder=="Desc"?"Asc":"Desc";
                                    // filterBy="orderNumber";
                                    // filterByDate=false;
                                    product();
                                ...
                                child: Container(
                                    width: 100,
                                    // color: Colors.blue,
                                    child: Text("Total", style: TextStyle(fontSize: 12, color: Colors.black54, fontWeight: FontWeight.bold),)),
                              ),
                            ),
                            Tooltip(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            width: 100,
                                            // color: Colors.blue,
                                            child: orderPagnation!=null?Text("${orderPagnation?.items?[index].addedBy}", style: TextStyle(fontSize: 10, color: Colors.black54),):Container(margin: EdgeInsets.only(right: 40), height: 10, decoration: BoxDecoration(color: Color(0xfff8f8f8), borderRadius: BorderRadius.all(Radius.circular(5))),)),
                                        Container(
                                            width: 100,
                                            // color: Colors.blue,
                                            child: orderPagnation!=null?Text("${orderPagnation?.items?[index].total}", style: TextStyle(fontSize: 10, color: Colors.black54),):Container(margin: EdgeInsets.only(right: 40), height: 10, decoration: BoxDecoration(color: Color(0xfff8f8f8), borderRadius: BorderRadius.all(Radius.circular(5))),)),
                                        Container(
                                            width: 100,
                                            // color: Colors.blue,
                                            child: orderPagnation!=null?Text("${orderPagnation?.items?[index].note==""?"---":orderPagnation?.items?[index].note}", style: TextStyle(fontSize: 10, color: Colors.black54),):Container(margin: EdgeInsets.only(right: 40), height: 10, decoration: BoxDecoration(color: Color(0xfff8f8f8), borderRadius: BorderRadius.all(Radius.circular(5))),)),
                                        Container(
                                          width: 100,
                                          // color: Colors.blue,
                                          child: orderPagnation!=null?Text("${orderPagnation?.items?[index].addedBy}", style: TextStyle(fontSize: 10, color: Colors.black54),):Container(margin: EdgeInsets.only(right: 40), height: 10, decoration: BoxDecoration(color: Color(0xfff8f8f8), borderRadius: BorderRadius.all(Radius.circular(5))),),),
